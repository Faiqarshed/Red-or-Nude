...
export default async function BookingsPage({
  ...
  if (!branchId) {
    return <BookingsView date={date} branches={[]} stations={[]} bookings={[]} noShows={[]} catalog={{ services: [], addons: [], removals: [] }} canManage={false} canReschedule={false} checkinEarlyMin={0} branchId="" />;
  }
