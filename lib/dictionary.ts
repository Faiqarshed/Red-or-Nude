...
const ar = {
  ...
  booking: {
    ...
    guestBranch: "الفرع",
    guestTime: "الموعد",
    sameDayNote: "كل الضيفات في نفس اليوم. اختاري يوماً واحداً للمجموعة.",
...
const en: Content = {
  ...
  booking: {
    ...
    removeGuest: "Remove",
    guestBranch: "Branch",
    guestTime: "Appointment",
    sameDayNote: "Everyone books on the same day. Pick one day for the group.",
    subtotal: "Subtotal",
