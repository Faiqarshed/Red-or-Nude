...
const ar = {
  ...
  packs: {
    ...
    howSteps: [
      ...
      "فعّلي خيار «استخدمي رصيد عضويتك» قبل الدفع — يُخصم رصيد واحد وتصبح الخدمة بلا مقابل.",
    ],
    howNote: "الرصيد لكل خدمة على حدة ولا يُنقل بينها. الإضافات وإزالة الطلاء تُدفع كالمعتاد.",
    bought: "تم الشراء",
  ...
  payment: {
    ...
    coveredNote: "خدمتك مدفوعة من رصيد عضويتك. لن يُخصم من بطاقتك شيء مقابلها.",
...
const en: Content = {
  ...
  packs: {
    ...
    checkout: "Checkout",
    pickOne: "Pick a membership to continue",
    ...
    howSteps: [
      ...
      "Tick “Use a credit from your membership” before you pay — one credit comes off and the service costs nothing.",
    ],
    howNote: "Credits are per service and can't be moved between them. Add-ons and removals are paid for as usual.",
    bought: "Bought",
  ...
  payment: {
    ...
    coveredNote: "Your service is paid from your membership credit. Nothing is taken from your card for it.",
