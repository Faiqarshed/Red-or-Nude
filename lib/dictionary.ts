...
const ar = {
  ...
  history: {
    ...
    verifyIntroLookup: "سنرسل رمزاً إلى بريدك الإلكتروني لفتح حجزك.",
    sessionExpired: "انتهت صلاحية جلستك. ابحثي عن حجزك مرة أخرى.",
...
const en: Content = {
  ...
  history: {
    ...
    verifyIntroLookup: "We'll email you a code to open your booking.",
    sessionExpired: "That's expired — look your booking up again.",
